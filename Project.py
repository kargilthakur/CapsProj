...
def GUI():
    ...
    Text(mainpage, "Welcome to Bank of India ATM", size=32, font="Open sans", align="top")
    Text(mainpage, "\n\n\nPlease enter card to begin transaction\n\n\n", size=20)
    Text(mainpage, "Blind mode on", align="bottom", size=10)
    PushButton(mainpage, command=exitmachine, text="Stop Machine", align="bottom")
